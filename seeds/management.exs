...
defmodule FakeDataGenerator do
  # 中文词库：形容词
  @adjectives [
    "快乐的",
    "有趣的",
...
for i <- 1..10_000 do
  ...
  params = %{
    id: i,
    type: :supergroup,
    title: FakeDataGenerator.generate_title(),
    description: FakeDataGenerator.generate_description(),
    username: FakeDataGenerator.generate_username(),
    is_take_over: is_take_over,
    left: left
  }

  {:ok, chat} = Uses.add_chat(params)
end
