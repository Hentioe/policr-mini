...
export default () => {
  ...
  return (
    <header class="fixed top-0 w-full h-header bg-white/40 backdrop-blur-md shadow flex items-center justify-between px-edge">
      <Icon onClick={handleToggleDrawer} icon="mdi:menu" class="text-[2rem] w-[2rem]" />
