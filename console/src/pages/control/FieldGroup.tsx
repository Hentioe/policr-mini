...
export default (props: { title: string; icon: string; children: JSX.Element }) => {
  return (
    <div class="pb-[1rem] bg-card border-l-4 border-blue-400 hover:border-blue-500 rounded shadow hover:shadow-lg hover:translate-x-[1px] hover:translate-y-[-1px] transition-all">
