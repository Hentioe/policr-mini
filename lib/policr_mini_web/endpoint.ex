defmodule PolicrMiniWeb.Endpoint do
  ...
  plug Plug.Static,
    ...
    from: :policr_mini,
    gzip: false,
    only: ~w(assets css fonts images svg js favicon.ico robots.txt)
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :policr_mini
  end
